...
bg=(randint(0,225),randint(0,225),randint(0,225))
...
while loop:
  ...
  draw_string("Energy:",80,0,"blue","cyan")
  fill_rect(150,3,int(penergy),12,"red")
 
  draw_string("Score:"+str(int(pscore)),205,0,"black","cyan")
